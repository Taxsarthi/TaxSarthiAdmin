...
const ChangePassword: React.FC<Props> = (props: Props) => {
  return (
    <div className="flex flex-col p-6 max-w-sm mx-auto h-[400px] border w-full rounded-lg">
      <div className="text-center mb-4">
        <h2 className="text-md md:text-lg font-bold">Change Password</h2>
        <p className="text-sm text-gray-600 mt-2">Update your existing password here.</p>
      </div>
