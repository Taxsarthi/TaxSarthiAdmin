  ...
  return (
    <div>
      ...
      <h1
        ...
        className={`text-center rounded-full py-1 px-2 cursor-pointer ${activeTab === 'user' ? 'bg-green-500' : ' '}`}
      >
        User Details
      </h1>
      <h1
        onClick={() => handleTabClick('itr')}
        className={`text-center rounded-full py-1 px-2 cursor-pointer ${activeTab === 'itr' ? 'bg-green-500' : ' '}`}
      >
        ITR
      </h1>
      <h1
        onClick={() => handleTabClick('tds')}
        className={`text-center rounded-full py-1 px-2 cursor-pointer ${activeTab === 'tds' ? 'bg-green-500' : ' '}`}
      >
        TDS
      </h1>
      <h1
        onClick={() => handleTabClick('docs')}
        className={`text-center rounded-full py-1 px-2 cursor-pointer ${activeTab === 'docs' ? 'bg-green-500' : ' '}`}
      >
        Docs
      </h1>
    </div>
